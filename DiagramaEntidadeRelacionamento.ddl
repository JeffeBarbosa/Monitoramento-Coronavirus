...
CREATE TABLE Sintoma (codsin SERIAL NOT NULL, covsin varchar(1) NOT NULL CHECK(covsin in ('S','N')), sitsin varchar(250) NOT NULL, intsin numeric(19, 0) NOT NULL, PRIMARY KEY (codsin));
